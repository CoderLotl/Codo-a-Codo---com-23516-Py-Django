...
document.addEventListener('DOMContentLoaded', async ()=>
{
    ...
    gameParams = JSON.parse(localStorage.getItem('game'))[0];    
    ...
    {
        SetCriteria();
        localStorage.setItem('search', searchCriteria);
...
function DrawDetails()
{
    ...
    gameImg.src = `static/core/Data/consoles/${gameDetails.console}/${gameDetails.folder}/${gameDetails.folder}1Principal.jpg`;
